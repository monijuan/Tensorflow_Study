...
def render_lapnorm(t_obj, img0, iter_n=10, step=1.0, octave_n=3, octave_scale=1.4, lap_n=4, channel=1):
    ...
    for octave in range(octave_n):
        ...
        for i in range(iter_n):
            ...
            img += g * step
            print('.', end=' ')
    savearray(img, 'lapnorm/lapnorm_%d.jpg'%channel)
...
if __name__ == '__main__':  
    ...
    for channel in range(143):
        render_lapnorm(layer_output[:, :, :, channel], img_noise, iter_n=20, channel=channel)
